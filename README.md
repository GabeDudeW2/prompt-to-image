...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/prompt-to-image)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/prompt-to-image
```

A live public deployment of this template is available at [https://prompt-to-image.templates.workers.dev](https://prompt-to-image.templates.workers.dev)
